...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'dist')],  # Look for templates in the dist folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dist'),  # React files are copied here by build-for-django command in frontend/package.json
]
